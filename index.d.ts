...
export declare function readFile(path: string | URL, raw?: boolean): Promise<string>;
export declare function readStdin(encoding?: string): Promise<string>;
export declare function resolvePath(path: string): Promise<string>;
...
export declare function selectFile(multiple?: boolean, fileExts?: string | string[]): Promise<LoadedFile[]>;
