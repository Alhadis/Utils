...
declare type Bytes = number[] | Uint8Array | Uint8ClampedArray;
...
export declare function adler32(bytes: Bytes): number;
...
export declare function ascii85Decode(input: string): Uint8Array;
export declare function ascii85Encode(bytes: Bytes): string;
...
export declare function bytesToInt16(bytes: Bytes, littleEndian?: boolean): Int16Array;
export declare function bytesToInt32(bytes: Bytes, littleEndian?: boolean): Int32Array;
export declare function bytesToInt64(bytes: Bytes, littleEndian?: boolean): BigInt64Array;
export declare function bytesToInt8(bytes: Bytes): Int8Array;
export declare function bytesToUint16(bytes: Bytes, littleEndian?: boolean): Uint16Array;
export declare function bytesToUint32(bytes: Bytes, littleEndian?: boolean): Uint32Array;
export declare function bytesToUint64(bytes: Bytes, littleEndian?: boolean): BigUint64Array;
...
export declare function crc32(data: Bytes): number;
...
export declare function int16ToBytes(input: number | number[] | Int16Array, littleEndian?: boolean): Uint8Array;
export declare function int32ToBytes(input: number | number[] | Int32Array, littleEndian?: boolean): Uint8Array;
export declare function int64ToBytes(input: bigint | bigint[] | BigInt64Array, littleEndian?: boolean): Uint8Array;
export declare function int8ToBytes(input: number | number[] | Int8Array): Uint8Array;
...
export declare function rgba(r: number, g: number, b: number, a: number): Uint8Array;
...
export declare function sha1(input: Bytes): string;
...
export declare function uint16ToBytes(input: number | number[] | Uint16Array, littleEndian?: boolean): Uint8Array;
export declare function uint32ToBytes(input: number | number[] | Uint32Array, littleEndian?: boolean): Uint8Array;
export declare function uint64ToBytes(input: bigint | bigint[] | BigUint64Array, littleEndian?: boolean): Uint8Array;
export declare function utf16Decode(input: string | number[], littleEndian?: boolean, addBOM?: boolean): Uint8Array;
export declare function utf16Encode(bytes: Bytes, opts?: {allowUnpaired?: boolean; codePoints?: boolean; endianness?: string}): string | number[];
export declare function utf32Decode(input: string | number[], littleEndian?: boolean, addBOM?: boolean): Uint8Array;
export declare function utf32Encode(bytes: Bytes, opts?: {codePoints?: boolean; endianness?: string}): string | number[];
export declare function utf8Decode(input: string | number[]): Uint8Array;
export declare function utf8Encode(bytes: Bytes, opts?: {allowOverlong?: boolean; allowSurrogates?: boolean; codePoints?: boolean; strict?: boolean; stripBOM?: boolean}): string | number[];
...
export declare function wsDecodeFrame(input: Bytes, noMask?: boolean): WSFrame;
