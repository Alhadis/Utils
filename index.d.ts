...
declare type WSFrame = {data: number[]; isFinal: boolean; isRSV1: boolean; isRSV2: boolean; isRSV3: boolean; length: BigInt; mask: number; opcode: number; opname: string};
...
export declare function bytesToUInt16(bytes: number[]): number[];
export declare function bytesToUInt32(bytes: number[]): number[];
export declare function bytesToUInt64(bytes: number[]): BigInt[];
...
export declare function wsDecodeFrame(input: number[]): WSFrame;
